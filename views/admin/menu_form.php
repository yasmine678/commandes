...
<div class="card" style="max-width:680px">
    <form method="post" action="/commandes/admin/menu-form.php<?= $id ? '?id=' . $id : '' ?>">
        ...
        <label>Prestations proposées cette semaine</label>
        <div class="dish-grid">
        ...
        <?php if (empty($allServices)): ?>
            <p class="muted">Aucune prestation n'existe encore. <a href="/commandes/admin/service-form.php">Créez-en une</a> d'abord.</p>
        <?php endif; ?>
